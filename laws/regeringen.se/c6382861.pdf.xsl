...
<xsl:variable name="filename" select="'http://www.regeringen.se/content/1/c6/13/75/74/c6382861.pdf'"/>
...
<xsl:variable name="note" select="'Main url: http://www.regeringen.se/sb/d/108/a/137574'"/>
